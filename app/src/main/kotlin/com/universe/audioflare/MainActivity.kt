...
import com.universe.compose.persist.PersistMapOwner
...
import com.universe.innertube.utils.LocalePreferenceItem
import com.universe.innertube.utils.LocalePreferences
import com.universe.innertube.utils.ProxyPreferenceItem
import com.universe.innertube.utils.ProxyPreferences
import com.universe.audioflare.enums.AudioQualityFormat
import com.universe.audioflare.enums.CheckUpdateState
import com.universe.audioflare.enums.ColorPaletteMode
import com.universe.audioflare.enums.ColorPaletteName
import com.universe.audioflare.enums.FontType
import com.universe.audioflare.enums.HomeScreenTabs
import com.universe.audioflare.enums.Languages
import com.universe.audioflare.enums.ThumbnailRoundness
import com.universe.audioflare.service.DownloadUtil
import com.universe.audioflare.service.PlayerService
import com.universe.audioflare.ui.components.BottomSheetMenu
...
import com.universe.audioflare.ui.screens.player.Player
import com.universe.audioflare.ui.screens.player.PlayerSheetState
import com.universe.audioflare.ui.screens.player.rememberPlayerSheetState
import com.universe.audioflare.ui.screens.playlistRoute
import com.universe.audioflare.ui.styling.Appearance
import com.universe.audioflare.ui.styling.Dimensions
import com.universe.audioflare.ui.styling.LocalAppearance
import com.universe.audioflare.ui.styling.colorPaletteOf
import com.universe.audioflare.ui.styling.dynamicColorPaletteOf
import com.universe.audioflare.ui.styling.typographyOf
import com.universe.audioflare.utils.InitDownloader
import com.universe.audioflare.utils.OkHttpRequest
import com.universe.audioflare.utils.UiTypeKey
import com.universe.audioflare.utils.applyFontPaddingKey
import com.universe.audioflare.utils.asMediaItem
import com.universe.audioflare.utils.audioQualityFormatKey
import com.universe.audioflare.utils.backgroundProgressKey
import com.universe.audioflare.utils.checkUpdateStateKey
import com.universe.audioflare.utils.closeWithBackButtonKey
import com.universe.audioflare.utils.colorPaletteModeKey
import com.universe.audioflare.utils.colorPaletteNameKey
import com.universe.audioflare.utils.disableClosingPlayerSwipingDownKey
...
import com.universe.audioflare.utils.fontTypeKey
import com.universe.audioflare.utils.forcePlay
import com.universe.audioflare.utils.getEnum
import com.universe.audioflare.utils.intent
import com.universe.audioflare.utils.isAtLeastAndroid6
import com.universe.audioflare.utils.isAtLeastAndroid8
import com.universe.audioflare.utils.isEnabledDiscoveryLangCodeKey
import com.universe.audioflare.utils.isKeepScreenOnEnabledKey
import com.universe.audioflare.utils.isProxyEnabledKey
import com.universe.audioflare.utils.keepPlayerMinimizedKey
import com.universe.audioflare.utils.languageAppKey
...
import com.universe.audioflare.utils.proxyHostnameKey
import com.universe.audioflare.utils.proxyModeKey
import com.universe.audioflare.utils.proxyPortKey
import com.universe.audioflare.utils.shakeEventEnabledKey
...
import com.universe.audioflare.utils.useSystemFontKey
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            if (preferences.getEnum(checkUpdateStateKey, CheckUpdateState.Ask) == CheckUpdateState.Enabled) {
                val urlVersionCode =
                    "https://raw.githubusercontent.com/skylinemusiccds/audioflare/master/updatedVersion/updatedVersionCode.ver"
                //val urlVersionCode = "https://audioflare.xyz/update/updatedVersionCode.ver"
                        ...
                        runOnUiThread {
                            try {
                                if (responseData != null) {
                                    val file = File(filesDir, "audioflareUpdatedVersionCode.ver")
...
*/
        ...
        Toast.makeText(this, "${"audioflare "}${getString(R.string.opening_url)}", Toast.LENGTH_LONG).show()
    ...
    override fun onDestroy() {
        ...
        //Log.d("audioflare debug","onDestroy")
    ...
    companion object {
        ...
        const val action_library = "com.universe.audioflare.action.library"
    }
