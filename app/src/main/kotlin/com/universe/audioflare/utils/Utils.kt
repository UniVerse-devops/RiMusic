...
import com.universe.innertube.utils.plus
...
import com.universe.audioflare.ui.components.themed.NewVersionDialog
...
fun CheckAvailableNewVersion(
    ...
    val file = File(LocalContext.current.filesDir, "audioflareUpdatedVersionCode.ver")
    if (file.exists()) {
...
fun isAvailableUpdate(): String {
    var newVersion = ""
    val file = File(LocalContext.current.filesDir, "audioflareUpdatedVersion.ver")
    if (file.exists()) {
...
fun checkInternetConnection(): Boolean {
    ...
    val url = "https://raw.githubusercontent.com/skylinemusiccds/audioflare/master/updatedVersion/updatedVersionCode.ver"
