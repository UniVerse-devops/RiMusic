...
import com.universe.audioflare.service.PlayerMediaBrowserService
...
import com.universe.audioflare.utils.isIgnoringBatteryOptimizations
            ...
            onClick = {
                ...
                try {
                    ...
                    try {
                        ...
                        context.toast("$msgNoBatteryOptim audioflare")
                    }
                }
            }
        )
