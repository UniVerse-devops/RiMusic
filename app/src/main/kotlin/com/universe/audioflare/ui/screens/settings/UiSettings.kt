...
import com.universe.audioflare.enums.MaxStatisticsItems
import com.universe.audioflare.enums.HomeScreenTabs
import com.universe.audioflare.enums.MaxSongs
...
import com.universe.audioflare.enums.PauseBetweenSongs
...
import com.universe.audioflare.enums.RecommendationsNumber
...
import com.universe.audioflare.utils.disableIconButtonOnTopKey
...
import com.universe.audioflare.utils.isSwipeToActionEnabledKey
...
import com.universe.audioflare.utils.lastPlayerThumbnailSizeKey
import com.universe.audioflare.utils.lastPlayerTimelineTypeKey
import com.universe.audioflare.utils.lastPlayerVisualizerTypeKey
import com.universe.audioflare.utils.maxSongsInQueueKey
import com.universe.audioflare.utils.maxStatisticsItemsKey
...
import com.universe.audioflare.utils.pauseBetweenSongsKey
...
import com.universe.audioflare.utils.recommendationsNumberKey
...
import com.universe.audioflare.utils.showStatsListeningTimeKey
...
fun  UiSettings() {
    ...
    var uiType  by rememberPreference(UiTypeKey, UiType.audioflare)
    ...
    Column(
        ...
        if (filter.isNullOrBlank() || stringResource(R.string.interface_in_use).contains(filterCharSequence,true))
            EnumValueSelectorSettingsEntry(
                ...
                valueText = {
                    when(it) {
                        UiType.audioflare -> UiType.audioflare.name
